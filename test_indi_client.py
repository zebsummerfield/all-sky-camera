# Run 'indiserver -v indi_simulator_telescope' to launch the server with the needed driver.

# A client that will try to connect to "Telescope Simulator" on the indiserver.
